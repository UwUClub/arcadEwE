...
Nibbler::MenuKeyboardHandler::MenuKeyboardHandler()
{
}

void Nibbler::MenuKeyboardHandler::run([[maybe_unused]] double deltaTime,
...
std::shared_ptr<Arcade::ECS::IEntity> Nibbler::MenuKeyboardHandler::getCurrentlyHoveredEntity(
