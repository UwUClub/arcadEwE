...
Nibbler::BufferWriterManager::BufferWriterManager(size_t score)
    : _score(score)
{
}

void Nibbler::BufferWriterManager::run(double deltaTime, Arcade::ECS::IEventManager& eventManager,
...
std::vector<std::string> Nibbler::BufferWriterManager::getEventsTriggered(
...
void Nibbler::BufferWriterManager::saveBuffer(const std::string& buffer)
{
